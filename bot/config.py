...
class Config(object):
    ...
    # auth users jdk 
    TG_BOT_TOKEN = "6068986914:AAGpsMMtUBrFTKtcXSb7SX9OZxN7SHHDnjQ"  # Updated with your bot token
    # the download location, where the HTTP Server runs
    DOWNLOAD_LOCATION = get_config("DOWNLOAD_LOCATION", "/app/downloads")
    # Telegram maximum file upload size
    BOT_USERNAME = "TOBI_ENCODER_23_BOT"  # Updated with your bot username
