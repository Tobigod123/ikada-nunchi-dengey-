...
async def convert_video(video_file, output_directory, total_time, bot, message, chan_msg):
    ...
    aa = kk.split(".")[-1]
    out_put_file_name = kk.replace(f".{aa}", "[world famous cartoon].mkv")
    ...
    file_genertor_command = (
        ...
        f'-map 0 '
        f'-vf "drawtext=fontfile=font.ttf:text=\'Encoded by > ahbokkale (world famous cartoon)\':x=\'w*0.95-text_w\':y=10:'
